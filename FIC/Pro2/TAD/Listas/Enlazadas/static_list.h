#ifndef static_list.h
#define static_list.h

#include <stdbool.h>

/* Definición de tipos de datos */
#define LNULL -1 //o valor que vamos a tomar nas listas estáticas co valor de nulo é -1
#define MAX 1000 //tamaño da lista

typedef int tItemL; //aquí está posto que o Item é de tipo int pero porque cadrou, porque pode ser do tipo que che pete
...
//as cabeceras das funcións que estean neste arquivo son as que a xente que implemente esta cabecera vai poder usar, se hai mái funcións na .c, esa función nn vai poder ser implementada.
